...
class Planner:
    def __init__(self):
        ...
        # read dock mesh
        self.dock_mesh = o3d.io.read_triangle_mesh("simple_dock.stl") # type: ignore
        ...
        self.voxel_indices = {}
        rospy.loginfo(f"hashing voxel grid...")
